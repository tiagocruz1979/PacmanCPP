...
{"p      ppp  f  pppppppppppppppppppppp      p  p  p  f   f     k                p"},
...
{"p      ppp                                 p  p  p                    pp       p"},
{"p  f   ppp                                 p p p p                    pp   f   p"},
{"p      ppppppppppppppppppppppppppppppppppppppppppp     pppppppp       pp       p"},
{"p              g                                       pppppppp   f   pp       p"},
{"p  f   f    f     f     f             f      f     f                           p"},
{"p                                                                          f   p"},
{"p                            b                      f      f       f           p"},
{"pppppppppppppp                                                                 p"},
{"pppppppppppppp                                  pppppppppppppppppppppppppppppppp"},
{"p               d                                                              p"},
{"p  t                                                                           p"},
